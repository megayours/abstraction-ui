...
export default function AccountLinkingPage() {
  ...
  const connectNewWallet = async () => {
    try {
      await connectSecondaryWallet(newAccountType, newWalletType);
    } catch (error) {
  ...
  const handleDisconnect = async () => {
    try {
      await disconnectSecondaryWallet();
    } catch (error) {
  ...
  const handleLinkAccount = async () => {
    ...
    try {
      ...
      await linkAccount(newAccountType, newWalletType, timestamp, secondaryAccount);
